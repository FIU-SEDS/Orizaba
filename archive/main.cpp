...
ASM330LHHSensor backup_IMU(&Wire2, ASM330LHH_I2C_ADD_L); // backup IMU ASM330LHH object
...
bool process_IMUs()
{
  ...
  float avg_gyro_x, avg_gyro_y, avg_gyro_z, avg_accel_x, avg_accel_y, avg_accel_z; // raw data values gyro saved in rad/s, accelerometer saved in m/s^2, and velocity saved in m/s
  ...
  Serial.println("Average Acceleration (m/s²):");
  Serial.print("  X: ");
  Serial.println(avg_accel_x);
  Serial.print("  Y: ");
  Serial.println(avg_accel_y);
  Serial.print("  Z: ");
  Serial.println(avg_accel_z);

  Serial.println("Angular Velocity (rad/s):");
  Serial.print("  X: ");
  Serial.println(avg_gyro_x);
  Serial.print("  Y: ");
  Serial.println(avg_gyro_y);
  Serial.print("  Z: ");
  Serial.println(avg_gyro_z);

  Serial.println("G-Forces:");
  Serial.print("  Total: ");
  Serial.println(total_g_force);
  Serial.print("  Z-Axis: ");
  Serial.println(z_axis_g_force);
  ...
  Serial.print("  X: ");
  Serial.println(linear_accel_x);
  Serial.print("  Y: ");
  Serial.println(linear_accel_y);
  Serial.print("  Z: ");
  Serial.println(linear_accel_z);

  // Serial.println("Linear Velocity (m/s):");
  // Serial.print("  X: ");
  // Serial.println(linear_velocity_x);
  // Serial.print("  Y: ");
  // Serial.println(linear_velocity_y);
  // Serial.print("  Z: ");
  // Serial.println(linear_velocity_z);
  // Serial.println("---------------------");
...
void setup()
{
  ...
  if (!power_on_main_IMU())
  {
    Serial.println("INIT main imu failed");
  }
  else if (!power_on_backup_IMU())
  {
    Serial.println("INIT backup imu failed");
  }
}
